describe('Platzi "PayPal payment method" test', function() {
    it('Payment flow choosing PayPal', function() {
        // Go to platzi.com
        ...
        cy.get('#checkout > div > div.Content > span > div > div.PaymentFormContent > div > div > div.PaymentOptions > div:nth-child(3) > div.PaymentOption > div > div.PaymentOption-circle')
            .click()
        // Click on 'pay with PayPal' btn
        cy.contains('Completar pago con PayPal')
            .click()
    })
})